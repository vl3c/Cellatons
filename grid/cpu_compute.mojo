"""CPU computation for Grid Game of Life.
...
from grid.rules import apply_grid_rules
...
struct CPUCompute:
    """CPU compute handler for Grid Game of Life.
    ...
    fn step(mut grid: Grid):
        ...
        fn process_row(row: Int):
            ...
            write_ptr[curr_offset] = apply_grid_rules(current, neighbors)
            ...
            while col + sw <= width - 1:
                ...
                # Apply grid rules per-element
                for i in range(sw):
                    write_ptr[curr_offset + col + i] = apply_grid_rules(
            ...
            while col < width - 1:
                ...
                write_ptr[curr_offset + col] = apply_grid_rules(current, neighbors)
                col += 1
            ...
            write_ptr[curr_offset + width - 1] = apply_grid_rules(current, neighbors)
