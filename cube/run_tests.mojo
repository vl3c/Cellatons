"""Test runner for cube automaton tests.

Run with: pixi run mojo cube/run_tests.mojo
"""

from python import Python
from testing import TestSuite

from cube.tests.test_grid import (
...
from cube.tests.test_rules import (
...
from cube.tests.test_gpu import (
...
fn run_python_renderer_tests() raises:
    ...
    sys.path.insert(0, "cube/renderer")
    sys.path.insert(0, "cube/tests")
