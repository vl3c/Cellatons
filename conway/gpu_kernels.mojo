"""Native Mojo GPU kernels for Conway's Game of Life.
...
@always_inline
fn _apply_conway_rules(current: Int, neighbors: Int) -> UInt8:
...
fn conway_generation_kernel(
    ...
    """GPU kernel to compute one generation of Conway's Game of Life.
    ...
    var result = _apply_conway_rules(current, neighbors)
