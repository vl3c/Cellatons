...
# - rules.mojo: Conway's rules logic
...
from .rules import apply_conway_rules, should_be_alive
from .cpu_compute import CPUCompute
from .gpu_kernels import conway_generation_kernel, get_kernel_dims, KernelDims
