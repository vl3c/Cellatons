...
from conway.benchmark.stats import BenchmarkStats
from conway.benchmark.result import BenchmarkResult
...
fn print_detailed_report(result: BenchmarkResult) raises:
    ...
    print()
    print("=" * 70)
    print("CONWAY'S GAME OF LIFE - BENCHMARK REPORT")
    print("=" * 70)
    print()
...
fn _append_simple_header(mut lines: List[String], timestamp: String, result: BenchmarkResult):
    ...
    lines.append("=" * 60)
    lines.append("Conway's Game of Life - Benchmark Results")
    lines.append("=" * 60)
...
fn _append_detailed_header(mut lines: List[String], timestamp: String, result: BenchmarkResult):
    ...
    lines.append("=" * 70)
    lines.append("CONWAY'S GAME OF LIFE - BENCHMARK REPORT")
    lines.append("=" * 70)
    lines.append("")
    lines.append("Timestamp: " + timestamp)
    lines.append("")
