"""Test runner for hypercube automaton tests.

Run with: pixi run mojo hypercube/run_tests.mojo
"""

from python import Python
from testing import TestSuite

from hypercube.tests.test_grid import (
    test_grid_dimensions,
    test_stride_alignment,
    test_layer_and_hyperlayer_stride,
    test_neighbor_count_center,
    test_neighbor_wraparound_edges,
)

from hypercube.tests.test_rules import (
...
from hypercube.tests.test_gpu import (
...
fn main() raises:
    print("=" * 60)
    print("Hypercube Automata TEST SUITE")
    print("=" * 60)
    print()
    ...
    suite.test[test_layer_and_hyperlayer_stride]()
...
fn run_python_renderer_tests() raises:
    ...
    sys.path.insert(0, "hypercube/renderer")
    sys.path.insert(0, "hypercube/tests")
