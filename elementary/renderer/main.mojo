"""Live viewer for elementary cellular automata.
...
Run: pixi run mojo elementary/renderer/main.mojo
"""
...
from elementary.renderer.base import init_display, RendererConfig
from elementary.renderer.python_module import PythonModuleRenderer
...
fn print_banner() raises:
    ...
    print("=" * 60)
    print("Elementary CA Live Viewer")
    print("=" * 60)
    print("Rule: 30")
...
fn run_viewer() raises:
    ...
    # Initialize display
    var config = init_display("Elementary CA - Rule 30")
