"""Persistent GPU compute handler for the voxel automaton."""

from gpu.host import DeviceContext, DeviceBuffer, HostBuffer
from layout import Layout, LayoutTensor
from memory import UnsafePointer
from voxel.gpu_kernels import voxel_generation_kernel, get_kernel_dims, grid_layout
...
struct GPUCompute:
    ...
    fn step(mut self) raises:
        ...
        if self.gpu_active == 0:
            ...
            self.ctx.enqueue_function_checked[voxel_generation_kernel, voxel_generation_kernel](
                read_tensor,
                write_tensor,
                self.width,
                self.height,
