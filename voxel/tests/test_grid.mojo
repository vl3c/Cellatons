"""Grid tests for the voxel automaton."""

from testing import assert_equal, assert_true
from voxel.grid import Grid, VOXEL_WIDTH, VOXEL_HEIGHT, VOXEL_DEPTH


fn test_grid_dimensions() raises:
    var grid = Grid()
    assert_equal(grid.width, VOXEL_WIDTH)
    assert_equal(grid.height, VOXEL_HEIGHT)
    assert_equal(grid.depth, VOXEL_DEPTH)
