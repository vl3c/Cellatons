"""3D voxel grid with double buffering (GPU-first).
...
alias VOXEL_WIDTH: Int = 96
alias VOXEL_HEIGHT: Int = 96
alias VOXEL_DEPTH: Int = 96
...
struct Grid(Movable):
    """Double-buffered 3D grid for the voxel automaton."""
    ...
    fn __init__(out self):
        ...
        self.width = VOXEL_WIDTH
        self.height = VOXEL_HEIGHT
        self.depth = VOXEL_DEPTH
        self.active = 0
