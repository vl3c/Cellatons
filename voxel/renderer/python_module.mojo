...
from voxel.renderer.base import RendererConfig
...
struct PythonModuleRenderer:
    ...
    fn _import_viewer() raises -> PythonObject:
        ...
        sys.path.append("voxel/renderer")
    ...
    fn render_frame(
        ...
        paused: Bool = False,
        width_logical: Int = VOXEL_WIDTH,
        height_logical: Int = VOXEL_HEIGHT,
        depth_logical: Int = VOXEL_DEPTH,
    ) raises:
