...
class TestRenderState(unittest.TestCase):
    ...
    def test_ensure_initialized_creates_buffers(self):
        ...
        self.assertEqual(state.rgb_buffer.shape, (600, 800, 3))
...
class TestRenderWindow(unittest.TestCase):
    ...
    def test_status_text_format(self):
        ...
        # Two text renders: status line and controls/help line
        self.assertGreaterEqual(mock_font.render.call_count, 2)
        # First call should contain progress and FPS
        first_call = mock_font.render.call_args_list[0][0][0]
        self.assertIn("75%", first_call)
        self.assertIn("120 FPS", first_call)
